...
export default function SubscriptionsPage({ subscriptions, onRefresh }: Props) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (editing) {
      updateSubscription(editing.id, { name: name.trim(), amount, billingCycle, nextBilling, category: category.trim(), notes: notes.trim() });
    } else {
      addSubscription({ name: name.trim(), amount, billingCycle, nextBilling, category: category.trim(), notes: notes.trim() });
    }
    setShowForm(false);
    onRefresh();
  };
            ...
            <form onSubmit={handleSubmit} className="modal-body">
              ...
              <div className="form-row">
                <div className="form-group">
                  ...
                  <input type="text" value={category} onChange={e => setCategory(e.target.value)} placeholder="Streaming, Seguro..." />
                </div>
                <div className="form-group">
                  <label>Notas</label>
